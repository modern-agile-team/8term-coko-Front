...
export const ACCESSPRIES_OPTIONS: CosmeticItemOption[] = [
  ...
  { label: '모자', query: { mainCategoryId: 2, subCategoryId: 1 } },
  { label: '안경', query: { mainCategoryId: 2, subCategoryId: 2 } },
  { label: '턱수염', query: { mainCategoryId: 2, subCategoryId: 3 } },
  { label: '스카프', query: { mainCategoryId: 2, subCategoryId: 4 } },
] as const;

export const BUTTION_LIST: {
  label: string;
